...
const CodeVerificationSection = () => {
  ...
  const keyFiles = [
    ...
    },
    {
      ...
      description: 'All SDK features with comprehensive implementation details',
      lines: '1-800+'
    },
    {
